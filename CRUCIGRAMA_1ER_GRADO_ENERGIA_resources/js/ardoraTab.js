...
function messagePlayAudio(typeMessage){ if (typeMessage=="Ok"){document.getElementById("audioFelicitacion").play()} if (typeMessage=="Error"){document.getElementById("audioErro").play()} if (typeMessage=="Attempts"){document.getElementById("audioIntentos").play()}}
